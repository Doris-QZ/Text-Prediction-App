...
The App supports English only so far, Because we only use the English text file to train the model.    
...
<font size="3">The algorithm in the model is called "Stupid Backoff". The basic idea is that:
...
^1^ score = (count of the last word) / (count of the first words)</font>
